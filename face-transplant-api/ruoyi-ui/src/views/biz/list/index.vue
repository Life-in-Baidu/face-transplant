<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="融合图片id集合" prop="mergeList">
        <el-input
          v-model="queryParams.mergeList"
          placeholder="请输入融合图片id集合"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="listList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="融合图片id集合" align="center" prop="mergeList" />
...
:value="parseInt(dict.value)"
        ...
        <el-form-item label="融合图片id集合" prop="mergeList">
          <el-input v-model="form.mergeList" placeholder="请输入融合图片id集合" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除融合组编号为"' + ids + '"的数据项？').then(function() {
        return delList(ids);
      }).then(() => {
        this.getList();
